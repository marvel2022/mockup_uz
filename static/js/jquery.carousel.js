   ...
   Carousel.prototype.setArrow=function(){
      if(this.options.arrow.isshow){
        ...
        if(this.type.indexOf('slidex')!=-1 || this.type=='opacx'){
         ...
         //   $carArrow.find('.arrow').css({'width':35,'height':60,'line-height':'60px','fontSize':this.options.arrow.arrowsize,'color':'#f00','background':'black','opacity':0.3,'position':'relative','top':(this.carheight-60)/2,'zIndex':4});
